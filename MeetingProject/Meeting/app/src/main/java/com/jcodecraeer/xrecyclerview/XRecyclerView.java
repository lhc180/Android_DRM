...
public class XRecyclerView extends RecyclerView {
	...
	private boolean loadingMoreEnabled = false;// 不弹出底层框
	...
	private boolean isOnTop() {
		...
		// firstVisibleItemPosition = ((GridLayoutManager)
		// layoutManager).findFirstVisibleItemPosition();
		// } else if ( layoutManager instanceof StaggeredGridLayoutManager ) {
		// int[] into = new int[((StaggeredGridLayoutManager)
		// layoutManager).getSpanCount()];
		// ((StaggeredGridLayoutManager)
		// layoutManager).findFirstVisibleItemPositions(into);
		// firstVisibleItemPosition = findMin(into);
		// } else {
		// firstVisibleItemPosition = ((LinearLayoutManager)
		// layoutManager).findFirstVisibleItemPosition();
		// }
