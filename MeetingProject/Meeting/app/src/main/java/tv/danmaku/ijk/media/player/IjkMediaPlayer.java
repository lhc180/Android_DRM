...
public final class IjkMediaPlayer extends AbstractMediaPlayer
{
	 ...
	 * Load them by yourself, if your libraries are not installed at default
	 * place.
	 */
	 ...
	 *            but that can be
	 *            changed with key/value pairs through the headers parameter
	 *            with
	...
	{
		mDataSource = path;
//		String paths = "/storage/sdcard0/Android/data/cdd1c554-b83c-461f-9acc-b23899ba816b_2.mp4";
//		String keys = "E24DB22E5BD621885D30CB9495F9EFD2";
	...
	//	private native void _setDataSourceWithKey(String path, String[] keys, String[] values,
	//			String waterMark) throws IOException, IllegalArgumentException, SecurityException,
	 ...
	 * responsibility
	 * to close the file descriptor. It is safe to do so as soon as this call
	 * returns.
	 * 
	 * @param fd
