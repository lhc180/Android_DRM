 ...
 * @date 2017/3/8 18:10
 */
public class LoginActivityPro extends BaseActivity implements View.OnClickListener  {
     ...
     * 动画的执行时间
     */
    private final long durationTime = 1000;
    ...
    private JGAdapter mechanismAdapter;
     ...
     * @param password
     */
    private void CallLoginWS(String username, String password, final String morganization_code) {
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.tv_register:
                OpenPageUtil.openActivity(LoginActivityPro.this, RegisterActivity.class);
                break;
            ...
            case R.id.tv_history_record:
                OpenPageUtil.openActivity(LoginActivityPro.this, ScanHistoryActivity.class);
                break;
            // 扫描机构码或者会议码
            case R.id.bt_Qrcode:
                SPUtils.remove(DRMUtil.KEY_LOGIN_TOKEN);
                OpenPageUtil.openZXingCode(LoginActivityPro.this);
                UIHelper.startInAnim(LoginActivityPro.this);
                break;
            // 登陆
            case R.id.btn_login:
    ...
    private void saveMetScan(final String dataSource) {
        ...
        final String MeetingId = StringUtil.getStringByResult(dataSource, "id=");
            ...
            public void onSuccess(ResponseInfo<String> arg0) {
                ...
                if (metNameModel.isSuccess()) {
                    ...
                    if (!"0".equals(metBean.getVerify())) {
                        OpenPageUtil.openScanLoginVerificationActivity(LoginActivityPro.this, sh);
                    } else {
                        SPUtils.save(DRMUtil.VOTE_URL, metBean.getUrl());
                        SPUtils.save(DRMUtil.KEY_PHONE_NUMBER, "");
                        OpenPageUtil.openDownloadMainByScaning2(LoginActivityPro.this, sh);
                    }
                    hideBgLoading();
                } else {
                    showToast("服务器异常");
     ...
     */
    private ScanHistory SaveScanHistory( final String username, final String MeetingId, final String MeetingType, final String DataSource, MeetingNameModel.MeetingName o) {
    ...
    private void OpenActivity(String morganization_code) {
        OpenPageUtil.openMyMeetingActivity(LoginActivityPro.this, morganization_code);
    }
