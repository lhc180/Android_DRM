...
public class FlingGalleryView extends ViewGroup
{
	 ...
	 * 注册滚动到指定屏幕的事件
	 */
	public void setOnScrollToScreenListener(OnScrollToScreenListener scrollToScreenListener)
	{
	 ...
	 * 注册自定义Touch事件
	 */
	public void setOnCustomTouchListener(OnCustomTouchListener customTouchListener)
	{
