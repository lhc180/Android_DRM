...
//        return ctx.getResources().getConfiguration().hardKeyboardHidden == Configuration
...
//    }
    ...
    public static int getCPUMaxFreqKHz() {
        ...
        try {
            ...
            for (int i = 0; i < coreCount; i++) {
                String filename = "/sys/devices/system/cpu/cpu" + i
        ...
        try {
            if (new File("/proc/meminfo").exists()) {
                ...
                if (meminfo != null) {
                    ...
                    if (meminfo == null || "".equals(meminfo)) {
                        total = 0L;
                    } else {
                        total = Long.parseLong(meminfo);
                    }
                }
            }
        } catch (Exception e) {
     ...
     */
    private static int parseFileForValue(String textToMatch,
        ...
        while (index < buffer.length && buffer[index] != '\n') {
            if (Character.isDigit(buffer[index])) {
                ...
                while (index < buffer.length
                        && Character.isDigit(buffer[index])) {
                    index++;
                }
...
//        Bitmap bitmap = Bitmap.createBitmap(sourceB, 0, statusBarHeight, width,
...
//    }
     ...
     */
    public static ArrayList<String> getExtExternalStorageList() {
