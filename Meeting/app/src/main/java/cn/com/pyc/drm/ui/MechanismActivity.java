...
import cn.com.pyc.drm.adapter.MechanismAdapter;
import cn.com.pyc.drm.adapter.MechanismAdapter2;
 ...
 * @version V1.0
 */
public class MechanismActivity extends BaseActivity implements OnClickListener {
	...
	private MechanismAdapter2 mAdapter;
	...
	*/
	...
	private void initListener() {
		...
		mlv_mechanism.addOnItemTouchListener(new RecyclerViewClickListener(this, mlv_mechanism, new RecyclerViewClickListener.onItemClickListener() {
			@Override
			public void onItemClick(View view, int position) {
				...
				if ("ForScanHistoryActivity".equals(isForActivity)) {
					...
					openActivity(MyMeetingActivity.class, bundle);
...
//		mlv_mechanism.setOnItemClickListener(new OnItemClickListener() {
//			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
//				MechanismBean mmechanis_data = listStr.get(position);
//				if (TextUtils.isEmpty(mmechanis_data.getServerAddress()) || TextUtils.isEmpty(mmechanis_data.getServerName()) || TextUtils.isEmpty(mmechanis_data.getSZUserName())) {
//					showToast("机构数据异常");
//					return;
//				}
...
//		});
	...
	private void setAdapter(List<MechanismBean> liststr, String PhoneNumber) {
		if (mAdapter == null) {
			mAdapter = new MechanismAdapter2(getApplication(),liststr, PhoneNumber);
