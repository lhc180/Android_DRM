...
import net.file.FileSortHelper.SortMethod;
import net.file.MediaFile.MediaFileType;
...
public class FileCategoryHelper {
	...
	private String buildDocSelection() {
		...
		Iterator<String> iter = DRMUtil.sDocMimeTypesSet.iterator();
		while (iter.hasNext()) {
	...
	public static FileCategory getCategoryFromPath(String path) {
		...
		if (type != null) {
			...
			if (DRMUtil.sDocMimeTypesSet.contains(type.mimeType))
