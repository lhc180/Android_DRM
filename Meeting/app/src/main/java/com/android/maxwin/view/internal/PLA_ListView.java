...
public class PLA_ListView extends PLA_AbsListView
{
	...
	protected void layoutChildren()
	{
		...
		try
		{
			...
			DRMLog.e("PLA_ListView", "mItemCount = "+mItemCount+"------mAdapter.getCount = " +mAdapter.getCount());
...
//						+ "your adapter is not modified from a background thread, but only " + "from the UI thread. [in ListView(" + getId() + ", "
