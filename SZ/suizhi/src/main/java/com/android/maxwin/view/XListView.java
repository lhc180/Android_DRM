...
import com.android.maxwin.view.internal.PLA_AbsListView.OnScrollListener;
...
public class XListView extends MultiColumnListView implements OnScrollListener
{
	...
	private static int PULL_LOAD_MORE_DELTA = 120; // default value 120,when
													// pull up >= 120px
													// at bottom,
													// trigger
													// load more.
	...
	private String REFRESH_TIME = "setRefreshTime";
	// 快速滑动是否加载图片,默认加载
	private boolean isFlingLoadImage = true;

	public void setFlingLoadImage(boolean isFlingLoadImage)
	{
		this.isFlingLoadImage = isFlingLoadImage;
	}
	...
	private void initWithContext(Context context)
	{
		...
		PULL_LOAD_MORE_DELTA = CommonUtil.dip2px(context, 60f);
	...
	{
		// if (time == null)
		// time = DateUtils.formatDateTime(getContext(),
		...
		mHeaderTimeView.setText(TimeUtil.getTimeString(getContext(), date));
	}
