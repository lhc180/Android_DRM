...
public class MuPDFCore {
    ...
    private native long openFile(String filename, byte[] key, long codeLen, long offset);
    ...
    private native void updatePageInternal(Bitmap bitmap, int page, int pageW, int pageH,
                                           int patchX, int patchY, int patchW, int patchH, long
                                                   cookiePtr);
    ...
    public MuPDFCore(Context context, String filename, byte[] key, long codeLen, long offset)
            throws Exception {
        globals = openFile(filename, key, codeLen, offset);
        if (globals == 0) {
            throw new Exception("无法打开文档：" + filename);
        }
    ...
    public synchronized void drawPage(Bitmap bm, int page, int pageW, int pageH, int patchX,
                                      int patchY, int patchW, int patchH, MuPDFCore.Cookie cookie) {
        gotoPage(page);
    ...
    public synchronized void updatePage(Bitmap bm, int page, int pageW, int pageH, int patchX,
                                        int patchY, int patchW, int patchH, MuPDFCore.Cookie
												cookie) {
