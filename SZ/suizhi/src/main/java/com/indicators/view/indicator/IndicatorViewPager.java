...
import com.indicators.view.adapter.RecyclingPagerAdapter;
import com.indicators.view.indicator.Indicator.IndicatorAdapter;
import com.indicators.view.indicator.Indicator.OnItemSelectedListener;
...
public class IndicatorViewPager
{
	...
	public void setOnIndicatorPageChangeListener(
			OnIndicatorPageChangeListener onIndicatorPageChangeListener)
	{
	...
	private OnPageChangeListener onPageChangeListener = new OnPageChangeListener()
	{
		...
		public void onPageSelected(int position)
		{
			...
			if (onIndicatorPageChangeListener != null)
			{
				onIndicatorPageChangeListener.onIndicatorPageChange(
						indicatorView.getPreSelectItem(), position);
			}
		}
	 ...
	 * 
	 */
	public static abstract class IndicatorViewPagerAdapter implements
			IndicatorPagerAdapter
	{
		...
		private IndicatorAdapter indicatorAdapter = new IndicatorAdapter()
		{
			...
			{
				return IndicatorViewPagerAdapter.this.getViewForTab(position,
						convertView, parent);
			}
		...
		private RecyclingPagerAdapter pagerAdapter = new RecyclingPagerAdapter()
		{
			...
			public View getView(int position, View convertView,
					ViewGroup container)
			{
				return IndicatorViewPagerAdapter.this.getViewForPage(position,
		...
		public abstract View getViewForTab(int position, View convertView,
				ViewGroup container);

		public abstract View getViewForPage(int position, View convertView,
				ViewGroup container);
	 ...
	 * 
	 */
	public static abstract class IndicatorFragmentPagerAdapter implements
			IndicatorPagerAdapter
	{
		...
		public IndicatorFragmentPagerAdapter(FragmentManager fragmentManager)
		{
			...
			pagerAdapter = new FragmentListPageAdapter(fragmentManager)
			{
				...
				{
					return IndicatorFragmentPagerAdapter.this
							.getFragmentForPage(position);
				}
			};
		}
		...
		private IndicatorAdapter indicatorAdapter = new IndicatorAdapter()
		{
			...
			public View getView(int position, View convertView, ViewGroup parent)
			{
				return IndicatorFragmentPagerAdapter.this.getViewForTab(
