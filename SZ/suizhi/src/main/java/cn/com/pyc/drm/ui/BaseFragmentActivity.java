    ...
    private void noBuy(final String proId, String category) {
        ViewUtil.DialogCallBackPat callBack = new ViewUtil.DialogCallBackPat() {
            ...
            public void onCancel() {
                ClipboardUtil.clearClipboard(BaseFragmentActivity.this); //清空剪贴板
            }

            @Override
            public void onConfirm() {
                OpenPageUtil.openBrowserOfSystem(BaseFragmentActivity.this, APIUtil
                        .getProductDetailUrl(proId, null));
            }
        };
        ...
        if (ac == null) {
            ...
            ViewUtil.showCommonDialog(this, "",
                    ...
                    new ViewUtil.DialogCallBackPat() {
                        @Override
                        public void onConfirm() {
                            OpenPageUtil.openFileListPageToDownload(BaseFragmentActivity.this, o,
                                    itemId);
                        }
            ...
            ViewUtil.showCommonDialog(this, "",
                    ...
                    new ViewUtil.DialogCallBackPat() {
                        ...
                        public void onConfirm() {
                            ...
                            OpenPageUtil.openPageFromCheck(BaseFragmentActivity.this, category,
