...
public class ArrowRefreshHeader extends LinearLayout implements BaseRefreshHeader {
    ...
    private void initView() {
        ...
        mArrowImageView.setImageDrawable(getContext().getResources().getDrawable(R.drawable
                .xlistview_arrow));

        //init the progress view
        mProgressBar = (SimpleViewSwitcher) findViewById(R.id.listview_header_progressbar);
        //AVLoadingIndicatorView progressView = new AVLoadingIndicatorView(getContext());
        AVLoadingIndicatorView progressView = getAvLoadingView(getContext());
        progressView.setIndicatorColor(getContext().getResources().getColor(R.color
                .title_bg_color));
        //progressView.setIndicatorId(ProgressStyle.BallSpinFadeLoader);
        progressView.setIndicator(ProgressStyle.applyIndicator(ProgressStyle.BallSpinFadeLoader));
        ...
        switch (state) {
            ...
            case STATE_RELEASE_TO_REFRESH:
                if (mState != STATE_RELEASE_TO_REFRESH) {
                    ...
                    mStatusTextView.setText(R.string.xRecyclerView_header_hint_release);
                }
                break;
            case STATE_REFRESHING:
                mStatusTextView.setText(R.string.xRecyclerView_refreshing);
                break;
            case STATE_DONE:
                mStatusTextView.setText(R.string.xRecyclerView_refresh_done);
                break;
            default:
        }
