...
public class PullListView extends ListView
{
	...
	private final static float RATIO = 2.0f;//1.8f;
	...
	// 刷新中忙碌框
	private com.wang.avi.AVLoadingIndicatorView pbHeadRefreshing;
	...
	// 加载更多忙碌框
	private AVLoadingIndicatorView pbFootRefreshing;
	 ...
	 * 用户有时需要控制添加Header的顺序,可以将此属性设置为true，并在合适的时机，主动调用addPullHeader()方法，
	 * 去添加下拉刷新Header
	 */
	...
	private void init(Context context, AttributeSet attrs)
	{
		...
		if (arr != null)
		{
			addPullHeaderByUser = arr.getBoolean(R.styleable.PullListView_addPullHeaderByUser,
					addPullHeaderByUser);
		...
		pbHeadRefreshing = (AVLoadingIndicatorView) headView.findViewById(R.id.pb_head_refreshing);
		...
		pbFootRefreshing = (AVLoadingIndicatorView) footView.findViewById(R.id.pb_foot_refreshing);
	...
	private void initAnimation()
	{
		...
		//反向旋转
		reverseAnimation = new RotateAnimation(180, 360, RotateAnimation.RELATIVE_TO_SELF, 0.5f,
				RotateAnimation.RELATIVE_TO_SELF, 0.5f);
	...
	private void changeHeaderViewByState()
	{
		switch (state)
		{
			case NONE:
				...
				ivHeadArrow.setImageResource(R.drawable.xlistview_arrow);
	 ...
	 */
	public void doOnScroll(AbsListView view, int firstVisibleItem, int visibleItemCount,
			int totalItemCount)
	{
