...
/**
 * 添加header和footer的RecyclerView
 *
 * @author github: https://github.com/jianghejie/XRecyclerView
 */
public class XRecyclerView extends RecyclerView {
    ...
    private boolean isReservedItemViewType(int itemViewType) {
        if (itemViewType == TYPE_REFRESH_HEADER || itemViewType == TYPE_FOOTER || sHeaderTypes
                ...
                gridManager.setSpanSizeLookup(new GridLayoutManager.SpanSizeLookup() {
                    ...
                    public int getSpanSize(int position) {
                        return (mWrapAdapter.isHeader(position) || mWrapAdapter.isFooter
                                (position) || mWrapAdapter.isRefreshHeader(position))
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                mLastY = ev.getRawY();
                if (isOnTop() && pullRefreshEnabled && appbarState == AppBarStateChangeListener
                        .State.EXPANDED) {
...
//        }
        ...
        public void onAttachedToRecyclerView(RecyclerView recyclerView) {
            ...
            if (manager instanceof GridLayoutManager) {
                ...
                gridManager.setSpanSizeLookup(new GridLayoutManager.SpanSizeLookup() {
                    @Override
                    public int getSpanSize(int position) {
                        return (isHeader(position) || isFooter(position) || isRefreshHeader
                                (position))
                                ? gridManager.getSpanCount() : 1;
                    }
                });
        ...
        public void onViewAttachedToWindow(ViewHolder holder) {
            ...
            if (lp != null
                    ...
                    && (isHeader(holder.getLayoutPosition()) || isRefreshHeader(holder
                    .getLayoutPosition()) || isFooter(holder.getLayoutPosition()))) {
