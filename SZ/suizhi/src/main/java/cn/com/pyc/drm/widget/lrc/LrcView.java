...
public class LrcView extends View {
    ...
    private void init(AttributeSet attrs) {
        ...
        mTextSize = ta.getDimension(R.styleable.LrcView_lrcTextSize, LrcHelp.sp2px(getContext(),
                12));
        mDividerHeight = ta.getDimension(R.styleable.LrcView_lrcDividerHeight, LrcHelp.dp2px
                (getContext(), 16));
    ...
    public void loadLrc(final File lrcFile) {
        ...
        setFlag(lrcFile);
        AsyncTask<File, Integer, List<LrcEntry>> loadLrcTask = new AsyncTask<File, Integer,
                List<LrcEntry>>() {
            @Override
    ...
    public void loadLrc(final String lrcText) {
        ...
        setFlag(lrcText);
        AsyncTask<String, Integer, List<LrcEntry>> loadLrcTask = new AsyncTask<String, Integer,
                List<LrcEntry>>() {
            @Override
    ...
    private void newlineAnimation(int index) {
        ...
        mAnimator = ValueAnimator.ofFloat(mLrcEntryList.get(index).getTextHeight() +
                mDividerHeight, 0.0f);
        mAnimator.setDuration(mAnimationDuration * mLrcEntryList.get(index).getStaticLayout()
                .getLineCount());
