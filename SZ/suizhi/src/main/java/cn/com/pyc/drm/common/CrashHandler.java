...
public class CrashHandler implements UncaughtExceptionHandler {
    ...
    // 用于格式化日期,作为日志文件名的一部分
    private DateFormat formatter = new SimpleDateFormat(LOGPATTERN);
    ...
    private String saveCrashInfo2File(Throwable ex) {
        ...
        LogerEngine.warn(mContext, result, extraParams);
        //添加日志上传--------------------------------
        ...
        try {
            ...
            if (CommonUtil.isSdCardCanUsed()) {
                String path = PathUtil.getDefaultSDCardRootPath() + "crash" + File.separator;
